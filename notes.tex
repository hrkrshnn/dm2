...
\label{sec:orgc5740bb}

\subsection{Review}
\label{sec:orgba65796}
\subsubsection{Random stuff about algorithms}
\label{sec:orgf53e51d}
Algorithm A
...
\label{sec:org5128617}
\subsubsection{Connectedness of graph}
\label{sec:orgf7dbbbf}
...
\label{sec:org7b779db}
\begin{enumerate}
\item Step 1
\label{sec:orga59ced4}
...
\label{sec:org2b1816e}
\subsection{Spanning trees}
\label{sec:org30a2129}
...
\label{sec:org43419ac}
\begin{enumerate}
\item Correctness
\label{sec:org22b472a}
...
\label{sec:orgf394f90}
\subsection{Decision problems}
\label{sec:org828b441}
Problems that output yes or no
\subsubsection{Example}
\label{sec:org57ecb50}
\begin{itemize}
...
\label{sec:orgd0854f5}
\subsubsection{Algorithm}
\label{sec:org5e2f1ef}
...
\label{sec:org63b2659}
\subsection{Maximum matching is in P}
\label{sec:orgc3add2b}
\subsubsection{Proposition}
\label{sec:orgf6c9012}
...
\label{sec:org52204bb}
\subsubsection{Definition (Vertex cut)}
\label{sec:org2274cbd}
...
\label{sec:org6901ea5}
\(K'(G) = \min\{[S, \bar{S}] colon S\subset V(G), S\neq \emptyset, S \neq V(G)
   \}\)
\subsubsection{Proof}
\label{sec:orgc48bb15}
...
\label{sec:orgfcd9e64}
\subsection{Menger's theorem (VMT)}
\label{sec:orge205eb3}
...
\label{sec:org587462b}
\subsubsection{Separating set}
\label{sec:orgb08692a}
\begin{enumerate}
...
\label{sec:org8b939f3}
\subsubsection{Example}
\label{sec:org88d9276}
A graph was drawn. 
\subsubsection{Definition}
\label{sec:orgaded950}
...
\label{sec:org51a4d02}
\subsection{Network}
\label{sec:org7178bc8}
...
\label{sec:org1664e64}
\subsection{LMVT proof}
\label{sec:org765239e}
\(V(D) = \{u^{+}, u^{-}, u \in V(D)\}\)
...
\label{sec:org8087efe}
\subsection{Colorings of graphs}
\label{sec:org10426ab}
\subsubsection{Example}
\label{sec:orga78b97c}
...
\label{sec:org12ab171}
Hajos conjecture is true for \(k=4\).
\subsubsection{Proof}
\label{sec:org7499ae4}
...
\subsection{Claim}
\label{sec:orgbe6f021}
\(\chi_l(G) \ge \chi(G)\)
\subsubsection{Proof}
\label{sec:orgd81ed0b}
...
\subsection{Complexity}
\label{sec:orgdf5943a}
It's not known to be in NP or in co-NP.
\subsection{Proposition}
\label{sec:org9f9e1d2}
...
\label{sec:orgaf3ce26}
\subsection{Definition}
\label{sec:orgc6ffa54}
...
coloring of \(G\), \(\chi'(G) = \min \{k \colon G \textup{ is k edge
   colorable}\}\).
\subsection{Examples}
\label{sec:org4ad52ab}
\subsubsection{Clique}
\label{sec:org426959e}
...
\label{sec:orgaab6c54}
\subsection{Lemma}
\label{sec:orgd646edb}
...
\label{sec:orgc34ea23}
\subsection{About network flows}
\label{sec:orgcfe0549}
...
\label{sec:orgf05d7ff}
\subsection{Linear programming (LP)}
\label{sec:org72790d5}
...
\label{sec:orgaa6bf11}
\subsection{Repetition}
\label{sec:org9c9db7f}
...
\label{sec:org80ffa52}
\begin{enumerate}
\item part a
\label{sec:org55e5f6f}
...
\label{sec:orgadbf983}
\end{enumerate}
\subsubsection{Exercise 4}
\label{sec:orgd9db292}
\begin{enumerate}
\item Counter example
\label{sec:orgf9d8363}
...
\label{sec:org4912427}
\begin{enumerate}
\item Part a
\label{sec:org7623d02}
It's easy
\item Part b
\label{sec:orgb0c92fc}
...
\label{sec:orgd52c6c0}
\subsubsection{Problem 1}
\label{sec:orgb66e2c9}
...
\subsubsection{Problem 2}
\label{sec:org1fe0abe}
\begin{enumerate}
\item part a
\label{sec:org8964b2e}
...
\label{sec:org50e5aa4}
\begin{enumerate}
\item Part a
\label{sec:orgea7c397}
...
\label{sec:org82cc919}
\subsubsection{Problem 1}
\label{sec:org750a5d2}
...
\label{sec:org558bbcb}
\subsubsection{Problem 1}
\label{sec:org2fff26b}
...
\label{sec:org50614e1}
\subsubsection{Problem 1}
\label{sec:org85c8e4a}
...
\label{sec:orgb4bd08f}
This is an example from the book.
\subsubsection{Exercise 5}
\label{sec:orge76bbab}
