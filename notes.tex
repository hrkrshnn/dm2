...
\label{sec:org394dd13}

\subsection{Review}
\label{sec:orgbea9a8a}
\subsubsection{Random stuff about algorithms}
\label{sec:org90f8b73}
Algorithm A
...
\label{sec:org5c0351e}
\subsubsection{Connectedness of graph}
\label{sec:org1bc4393}
...
\label{sec:orgbac73f6}
\begin{enumerate}
\item Step 1
\label{sec:org2884cb4}
...
\label{sec:org51a05cb}
\subsection{Spanning trees}
\label{sec:org1ee9b68}
...
\label{sec:org9f5e26a}
\begin{enumerate}
\item Correctness
\label{sec:orgef9dc4c}
...
\label{sec:org013b20a}
\subsection{Decision problems}
\label{sec:orgfda2939}
Problems that output yes or no
\subsubsection{Example}
\label{sec:org31639ab}
\begin{itemize}
...
\label{sec:org8faca43}
\subsubsection{Algorithm}
\label{sec:org39acce1}
...
\label{sec:org33b215f}
\begin{enumerate}
\item part a
\label{sec:org7268965}
...
\label{sec:org015167e}
\end{enumerate}
\subsubsection{Exercise 4}
\label{sec:orge6a931a}
\begin{enumerate}
\item Counter example
\label{sec:org45e55b5}
...
\label{sec:org91423c2}
\begin{enumerate}
\item Part a
\label{sec:org4e5ca79}
It's easy
\item Part b
\label{sec:org1597353}
...
\label{sec:org4c5d8e0}
\subsubsection{Problem 1}
\label{sec:orgb588e4c}
...
\end{enumerate}
\subsubsection{Problem 2}
\label{sec:org42623f5}
\begin{enumerate}
\item part a
\label{sec:orgc110910}
It is clear that \(\vert V \vert = \sum \textup{vertices in even components
     of G\S} + \sum \textup{vertices in odd components of G \ S} + \vert S \vert\)
...
\label{sec:org9093e54}
\begin{enumerate}
\item Part a
\label{sec:org81b4a26}
